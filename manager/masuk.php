...
<table id="myTable" class="table" cellspacing="0" width="100%">
	...
	<tbody>
		...
		$no = 0;
		$sql = mysql_query("SELECT * from mail where status= 'in' and confirm = 't'");
		...
		<?php }else{
		 ...
		 <tr style="background-color: #eee;">
			...
			<td style="text-align: right;"><?php echo $r[1] ?></td>
			<td style="text-align: right;">
			<a href="?menu=disposisi&id=<?= $r[0]?>" class="btn btn-outline-primary" title="Disposisikan Pesan"><i class="fa fa-share"></i></a>
