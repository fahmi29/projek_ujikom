...
<table id="myTable" class="display" cellspacing="0" width="100%">
	...
	<tbody>
		...
		$no = 0;
		$sql = mysql_query("SELECT * from mail where status= 'in'");
		...
		<tr>
			...
			<td style="text-align: right;"><a href="?menu=buka&id=<?php echo $r[0]?>" name="buka" class="btn btn-outline-success" title="Buka Pesan"><i class="fa fa-envelope-open"></i></a>
				...
				<a href="?menu=masuk&backup&id=<?= $r[0]  ?>" name="backup" class="btn btn-outline-warning" title="Backup"><i class="fa fa-undo"></i></a>
